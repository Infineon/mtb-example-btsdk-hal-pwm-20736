...
3. Execute any standard serial port terminal app on the host PC.
4. Once the application is running, push SW1 and every time the button is pressed, the PWM generated
   is used to illuminate LED2 with different levels of brightness.
5. Attach an oscilloscope to P28 to observe signal widths in detail.

## Build command example:
$ make TARGET=CYW920736M2EVB-01 program
